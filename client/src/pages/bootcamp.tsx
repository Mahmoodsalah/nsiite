    ...
    <div className="min-h-screen">
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center py-32">
          <Badge variant="outline" className="-mb-4 glass-badge rounded-full text-primary animate-fade-in">
            {heroBadge}
          </Badge>
          ...
          <h1
            className="font-heading font-bold text-4xl sm:text-5xl md:text-6xl text-foreground leading-tight mb-6 animate-fade-in-up -mt-4"
